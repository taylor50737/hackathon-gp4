  ...
  const filteredItems = React.useMemo(() => {
    ...
    if (hasSearchFilter) {
      ...
      filteredParticipants = filteredParticipants.filter(
        (participant) =>
          participant.last_name.toLowerCase().includes(lowerCaseFilterValue) ||
          participant.first_name.toLowerCase().includes(lowerCaseFilterValue) ||
          participant.parent_name.toLowerCase().includes(lowerCaseFilterValue)
      );
    }
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between gap-3 items-end">
          <Input
            ...
            placeholder="Search by participant or parent name..."
